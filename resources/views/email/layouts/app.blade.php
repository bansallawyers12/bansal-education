        ...
        <aside class="fixed inset-y-0 left-0 z-40 w-64 flex flex-col bg-slate-900/95 border-r border-slate-800 lg:static transform -translate-x-full lg:translate-x-0 transition-transform duration-200 ease-out peer-checked/sidebar:translate-x-0">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3">
                <ul class="space-y-0.5">
                    <li>
                        <a href="{{ route('dashboard') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('dashboard') ? 'bg-blue-600/20 text-blue-400' : 'text-slate-400 hover:bg-slate-800/80 hover:text-slate-200' }}">
                    ...
                    <li>
                        <a href="{{ route('emails.compose') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('emails.compose*') ? 'bg-blue-600/20 text-blue-400' : 'text-slate-400 hover:bg-slate-800/80 hover:text-slate-200' }}">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @endphp
                    <li>
                        <a href="{{ route('emails.index') }}" class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('emails.index') ? 'bg-blue-600/20 text-blue-400' : 'text-slate-400 hover:bg-slate-800/80 hover:text-slate-200' }}">
                    ...
                    <li>
                        <a href="{{ route('emails.drafts') }}" class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('emails.drafts') ? 'bg-blue-600/20 text-blue-400' : 'text-slate-400 hover:bg-slate-800/80 hover:text-slate-200' }}">
                            <span class="flex items-center gap-3">
                    ...
                    <li>
                        <a href="{{ route('emails.outbox') }}" class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('emails.outbox') ? 'bg-blue-600/20 text-blue-400' : 'text-slate-400 hover:bg-slate-800/80 hover:text-slate-200' }}">
                            <span class="flex items-center gap-3">
                    ...
                    <li>
                        <a href="{{ route('emails.sent') }}" class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('emails.sent') ? 'bg-blue-600/20 text-blue-400' : 'text-slate-400 hover:bg-slate-800/80 hover:text-slate-200' }}">
                            <span class="flex items-center gap-3">
                    ...
                    <li>
                        <a href="{{ route('emails.trash') }}" class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('emails.trash') ? 'bg-blue-600/20 text-blue-400' : 'text-slate-400 hover:bg-slate-800/80 hover:text-slate-200' }}">
                            <span class="flex items-center gap-3">
