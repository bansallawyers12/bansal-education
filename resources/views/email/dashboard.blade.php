        ...
        <div class="rounded-xl border border-slate-800 bg-slate-900/50">
                            ...
                            @foreach($recentEmails as $email)
                                <tr class="hover:bg-slate-800/50">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm">
                                        <a href="{{ route('emails.index', ['id' => $email->id]) }}" class="font-medium text-blue-400 hover:text-blue-300">View</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            @if($recentEmails->isNotEmpty())
                <div class="border-t border-slate-800 px-6 py-3">
                    <a href="{{ route('emails.index') }}" class="text-sm font-medium text-blue-400 hover:text-blue-300">View all emails →</a>
                </div>
            @endif
        </div>
    </div>
