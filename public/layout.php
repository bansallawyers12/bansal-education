            ...
            <div class="flex justify-between items-center h-36 py-2">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-8">
                        ...
                        <a href="about" class="<?php echo $current_page == 'about' ? 'text-navy border-b-2 border-gold' : 'text-gray-700 hover:text-navy hover:border-b-2 hover:border-gold'; ?> px-3 py-2 text-sm font-medium transition-colors duration-200">About Us</a>
                        <a href="courses" class="<?php echo $current_page == 'courses' ? 'text-navy border-b-2 border-gold' : 'text-gray-700 hover:text-navy hover:border-b-2 hover:border-gold'; ?> px-3 py-2 text-sm font-medium transition-colors duration-200">Courses</a>
                        <a href="services" class="<?php echo $current_page == 'services' ? 'text-navy border-b-2 border-gold' : 'text-gray-700 hover:text-navy hover:border-b-2 hover:border-gold'; ?> px-3 py-2 text-sm font-medium transition-colors duration-200">Student Services</a>
